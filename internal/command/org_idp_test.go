							...
							event, _ := org.NewLDAPIDPChangedEvent(context.Background(), &org.NewAggregate("org1").Aggregate,
								...
								[]idp.LDAPIDPChanges{
									...
									idp.ChangeLDAPAttributes(idp.LDAPAttributeChanges{
										IDAttribute:                new("new id"),
										FirstNameAttribute:         new("new firstName"),
										LastNameAttribute:          new("new lastName"),
										DisplayNameAttribute:       new("new displayName"),
										NickNameAttribute:          new("new nickName"),
										PreferredUsernameAttribute: new("new preferredUsername"),
										EmailAttribute:             new("new email"),
										EmailVerifiedAttribute:     new("new emailVerified"),
										PhoneAttribute:             new("new phone"),
										PhoneVerifiedAttribute:     new("new phoneVerified"),
										PreferredLanguageAttribute: new("new preferredLanguage"),
										AvatarURLAttribute:         new("new avatarURL"),
										ProfileAttribute:           new("new profile"),
									}),
